...
import com.chicken.util.LoginResultEnum;
import com.chicken.util.RegisterResultEnum;
...
public class UserBeanCl extends OperDB{
	...
	public LoginResultEnum checkLogin(UserBean userBean)
	{
		...
		try {
			...
			else if(!resultSet.getString(2).equals(userBean.getUpassword()))
	...
	public UserBean findUserByUid(String uid)
	{
		...
		try {
			...
			if (resultSet.next()) {
				userBean = new UserBean(resultSet.getString(1),null,resultSet.getString(3),
